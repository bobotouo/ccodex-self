...
const TRANSLATIONS = {
  "zh-CN": {
    ...
    "api.mcpHint": "在 opencode.jsonc 中配置: {\"mcp\":{\"image-gen\":{\"type\":\"local\",\"command\":[\"python3\",\"scripts/mcp_image_gen.py\"],\"environment\":{\"IMAGE_GEN_URL\":\"<上方地址>\",\"IMAGE_SAVE_DIR\":\"~/generated_images\"}}}}",
  ...
  en: {
    ...
    "api.codexResponses": "Codex Responses",
    "api.mcp": "MCP (OpenCode)",
    "api.mcpHint": "Configure in opencode.jsonc: {\"mcp\":{\"image-gen\":{\"type\":\"local\",\"command\":[\"python3\",\"scripts/mcp_image_gen.py\"],\"environment\":{\"IMAGE_GEN_URL\":\"<baseUrl>\",\"IMAGE_SAVE_DIR\":\"~/generated_images\"}}}}",
